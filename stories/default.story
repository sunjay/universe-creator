...
When you're writing your story, you should tell your user what they can
enter to continue onto the next screen. For example, on this screen,
you can enter "continue" to go to the next screen.

# You specify valid screens the user can go to using an arrow `->`
# followed by the ID of the screen the user can go to.
# You can specify alternate screens the user can go to using a slash.
# Think of it as typing "or" - that is, this/that
# A user can enter the ID `2` or `continue` to go to the next screen.
->$2/continue
...
This screen doesn't go anywhere, so it automatically ends the story.

$walk: Man...you're slow.
Run faster! Type 'run' to start running. Type 'walk' to continue walking...
